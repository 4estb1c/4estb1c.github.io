...
8. When the source has its own footnotes and rights permit reuse, carry them into notes with `kind: "original"`, preserving their text and links accurately. These are visibly styled apart from Inspector commentary. Never silently merge an original note with your own analysis.
